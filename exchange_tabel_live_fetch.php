        ...
        <TR>
          <TD align="left" colSpan=0 height="5">
            ...
            <table border="0" cellpadding="0" width="100%" cellspacing="0">
              ...
              <td colspan="12" id="data-container">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
              ...
              if ($row_h_menu) { ?>
                ...
                <tr bgcolor="#8181F7">
                  <td colspan="2" align="center" style="color:#fff">MONEDHA</td>
                  <td width="100"></td>
                  <td align="center" style="color:#fff">BLIHET</td>
                  <td width="100"></td>
                  <td align="center" style="color:#fff">SHITET</td>
                </tr>
                <tr>
                  <td height="5" colspan="6"></td>
                </tr>
