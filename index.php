...
if (!empty($_POST['email']) && !empty($_POST['password'])) {
    ...
    $stmt = $conn->prepare("SELECT id, username, full_name, id_trans, id_filiali, id_usertype, toggle, logo_image FROM app_user WHERE e_mail=? AND password=?");
    ...
    if ($result->num_rows > 0) {
        ...
        $_SESSION['logo_image'] = $myrow["logo_image"];
